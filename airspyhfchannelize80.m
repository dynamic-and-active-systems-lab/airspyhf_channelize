function []= airspyhfchannelize80(rawSampleRate) %#codegen
%AIRSPYFHCHANNELIZE80 receives complex (IQ) data over a UDP connection from 
%an Airspy HF+ or Airspy HF+ Discovery SDR, channelizes it, and servers it 
%up over 80 diferent UDP ports.
