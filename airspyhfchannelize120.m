function []= airspyhfchannelize120(rawSampleRate) %#codegen
%AIRSPYFHCHANNELIZE120 receives complex (IQ) data over a UDP connection from 
%an Airspy HF+ or Airspy HF+ Discovery SDR, channelizes it, and servers it 
%up over 120 diferent UDP ports.
