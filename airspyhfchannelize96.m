function []= airspyhfchannelize96(rawSampleRate) %#codegen
%AIRSPYFHCHANNELIZE96 receives complex (IQ) data over a UDP connection from 
%an Airspy HF+ or Airspy HF+ Discovery SDR, channelizes it, and servers it 
%up over 96 diferent UDP ports.
