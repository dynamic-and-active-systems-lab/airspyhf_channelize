function []= airspyhfchannelize12(rawSampleRate) %#codegen
%AIRSPYFHCHANNELIZE12 receives complex (IQ) data over a UDP connection from 
%an Airspy HF+ or Airspy HF+ Discovery SDR, channelizes it, and servers it 
%up over 12 diferent UDP ports.
