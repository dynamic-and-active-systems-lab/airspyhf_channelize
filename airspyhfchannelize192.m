function []= airspyhfchannelize192(rawSampleRate) %#codegen
%AIRSPYFHCHANNELIZE192 receives complex (IQ) data over a UDP connection from 
%an Airspy HF+ or Airspy HF+ Discovery SDR, channelizes it, and servers it 
%up over 192 diferent UDP ports.
