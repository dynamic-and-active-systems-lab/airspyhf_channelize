function []= airspyhfchannelize32(rawSampleRate) %#codegen
%AIRSPYFHCHANNELIZE32 receives complex (IQ) data over a UDP connection from 
%an Airspy HF+ or Airspy HF+ Discovery SDR, channelizes it, and servers it 
%up over 32 diferent UDP ports.
