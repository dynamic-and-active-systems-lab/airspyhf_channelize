function []= airspyhfchannelize**NUMBEROFCHANNELS**(rawSampleRate) %#codegen
%AIRSPYFHCHANNELIZE**NUMBEROFCHANNELS** receives complex (IQ) data over a UDP connection from 
%an Airspy HF+ or Airspy HF+ Discovery SDR, channelizes it, and servers it 
%up over **NUMBEROFCHANNELS** diferent UDP ports.
